...
angular.module( 'services.constants' )
    ...
    .service( 'templateItems', [ '$rootScope',
                                 function ( $rootScope ) {
                                     var dataButtons = [ {
                                         value: '[civilite]',
                                         message: 'Civilité'
